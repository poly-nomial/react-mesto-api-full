...
function Card(props) {
  ...
  const cardLikeClassName = `place__like ${
  ...
  return (
    <article className="place">
      <button
        ...
        className={`${cardDeleteButtonClassName} button-decor hover-opacity`}
      ...
      <div className="place__desc">
        ...
        <div className="place__likes">
          <button
            ...
            className={`${cardLikeClassName} button-decor hover-opacity`}
            onClick={handleLike}
          ></button>
